...
class _CategoryProductState extends State<CategoryProduct> {
  ...
  void initState() {
    super.initState();
    //print("CATPROSTAT :"+widget.childCatSlug);
    //print("parentCatName :"+widget.parentCatName);
    //print("subCatName :"+widget.subCatName);
    //print("I'm in Category Product");
    ...
    Get.find<CategoryProductController>().getCategoryProductList(widget.childCatSlug);
  }
    ...
    return WillPopScope(
      child: SafeArea(
        child: Scaffold(
          ...
          body: GetBuilder<CategoryProductController>(builder: (catProdController){
            return catProdController.isLoaded ? _buildBody(catProdController) : const Center(child: CircularProgressIndicator(color: AppColors.primaryColor),);
          }),
