...
class Dimensions{
  ...
  static double height48 = screenHeight/16.71;
  static double height50 = screenHeight/16.04;
  static double height56 = screenHeight/14.32;
  static double height100 = screenHeight/8.84;
  ...
  static double width304 = screenHeight/2.77;
  ...
  //Radius
  static double radius8 = screenHeight/100.25;
  ...
  //Appbar
  static double appBarLogoHeight = screenHeight/12.05;
  static double appBarLogoWidth = screenWidth/2.14;
