...
class RouteHelper{
  ...
  static String getSingleProductPage(String slug) => '$singleProductView?slug=$slug';
  static String getPaymentPage(String cartListJson) => '$paymentPage?cartListJson=$cartListJson';
  static String getWishListPage() => '$wishListPage';
  static String getAccountPage() => '$accountPage';
  ///Sub-category page
  static String getSubCategoryPage(String parentCatName,String parentCatSlug) =>
      '$subCategoryPage?parentCatName=$parentCatName&parentCatSlug=$parentCatSlug';
  ///Child-category page
  static String getChildCategoryPage(String parentCatName,String subCatName,String subCatSlug) =>
      '$childCategoryPage?parentCatName=$parentCatName&subCatName=$subCatName&subCatSlug=$subCatSlug';
  ///Category product page
  static String getCategoryProductPage(String parentCatName,String subCatName,String childCatName,String childCatSlug) =>
  ...
  static List<GetPage> routes = [
    ...
    GetPage(name: splashPage, page: () => SplashPage(),transition: Transition.fadeIn),
    GetPage(name: signInPage, page: () => LoginPage(),transition: Transition.fadeIn),
    ...
    GetPage(name: loginPage, page: () => Login(),transition: Transition.fadeIn),
    GetPage(name: registerPage, page: () => Registration(),transition: Transition.fadeIn),
    GetPage(name: verifyOtpPage, page: () {
      var phone = Get.parameters['phone'];
      return VerifyOtp(phone: phone!);
    } ,transition: Transition.fadeIn),
    GetPage(name: forgotPasswordPage, page: () => ForgotPassword(),transition: Transition.fadeIn),
    GetPage(name: initial, page: () => HomePage(),transition: Transition.fadeIn),
    GetPage(name: singleProductView, page: () {
    ...
    GetPage(name: accountPage, page: () => AccountPage(),transition: Transition.fade),

    ///Sub-category
    GetPage(name: subCategoryPage, page: () {
      var parentCatName = Get.parameters['parentCatName'];
      var parentCatSlug = Get.parameters['parentCatSlug'];
      return CategoryPage(parentCatName: parentCatName!,parentCatSlug: parentCatSlug!);
    },
      transition: Transition.fadeIn,
    ),

    ///Child Category
    GetPage(name: childCategoryPage, page: () {
      var parentCatName = Get.parameters['parentCatName'];
    ...
    /// Category Product
    GetPage(name: categoryProductPage, page: () {
      var parentCatName = Get.parameters['parentCatName'];
      var subCatName = Get.parameters['subCatName'];
    ...
    /// Seller Store
    GetPage(name: sellerStorePage, page: () {
